...
<a hidefocus="true" class="btn104 act" href="javascript:;" onClick="closeinfo()" id="btnMaskAreaSet"><LABEL id="laSet">移动区域设置</LABEL></a>
...
<a hidefocus="true" class="btn77 link" href="javascript:;" onClick="sumbitselclr()" id="btnMaskClear" disabled="disabled"><LABEL id="laCls">清除</LABEL></a>						</td>
                    </tr>
					<tr>
					  <td height="25" colspan="2" align="left" >					  </td>
				  </tr>
					<tr>
					  <td height="19" align="right"><LABEL id="laSensitivity">灵敏度</LABEL></td>
					  <td align="left">
					...
					<tr>
					  <td height="19" align="right"><LABEL id="laMotion">移动侦测</LABEL></td>
					  <td align="left"><input name="ckdetect" type="checkbox" id="ckdetect" value="0" onClick="$s('ckshelter').checked=false; $s('ckshelter').value='0'; checkClick('motion_frm','ckdetect');"/>
					...
					<tr>
					  <td width="35%" height="19" align="right" id="Tdtime1"><LABEL id="laTime1">布防时间段1</LABEL></td>
...
<input name="endm1" type="text" class="textmin" id="endm1" onKeyPress="event.returnValue=isDigit();" size="2" maxlength="2" /></td>
					...
					<tr>
					  <td height="25" align="right" id="Tdtime2"><LABEL id="laTime2">布防时间段2</LABEL></td>
		...
		<input name="endm12" type="text" class="textmin" id="endm12" onKeyPress="event.returnValue=isDigit();" size="2" maxlength="2" /></td>
					...
					<tr style="display:none;">
					  <td height="19" align="right" id="Tdtime3"><LABEL id="laTime3">布防时间段3</LABEL></td>
...
<input name="endm2" type="text" class="textmin" id="endm2" onKeyPress="event.returnValue=isDigit();" size="3" maxlength="2" /></td>
					...
					<tr style="display:none;">
					  <td height="25" align="right" id="Tdtime4"><LABEL id="laTime4">布防时间段4</LABEL></td>
	...
	<table width="680" border="1" cellpadding="5" cellspacing="1" bgcolor="#999999" style="margin:0px;">
		<tr>
		  <td height="21" colspan="5" bgcolor="#FFFFFF"><LABEL id="laLinkageAlarm">报警联动</LABEL></td>
	    </tr>
		<tr id="stralarmemail">
...
<span style="color:#FF0000; padding-right:12px;">*</span><LABEL id="laAlert1">移动报警检测灵敏度取值范围为1~5,值越大灵敏度越高</LABEL><br />
<span style="color:#FF0000; padding-right:12px;">*</span><LABEL id="laAlert2">抓拍时间间隔可以为小数,如:0.5秒,1.5秒等等</LABEL><br /><span style="color:#FF0000; padding-right:12px;">*</span><LABEL id="laAlert3">当设备上有挂存储器(硬盘、SD卡、U盘)时，联动抓拍、联动录像文件首先存储到存储器，同时根据文件存储方式再做相应的处理。否则会暂存在内存中，然后根据文件存储方式再做相应的处理</LABEL></div>
		<div class="boxtap">
