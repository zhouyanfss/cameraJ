...
function init(){
	ChangeLanguage('../xml/wireless.xml', m_szLanguage);
	try{
...
<div id="divMain">
	...
	<table width="680" border="1" cellpadding="5" cellspacing="1" bgcolor="#999999" style="margin:0px;">
		...
		<tr>
		  <td height="21" align="right" valign="bottom" bgcolor="#FFFFFF"><LABEL id="laDetection">联合移动侦测</LABEL></td>
		  <td colspan="4" bgcolor="#FFFFFF" ><input name="ckmotion" type="checkbox" id="ckmotion" value="0" onClick="checkclick('wireless_frm','ckmotion')"/></td>
		<tr>
