...
function init(){
	ChangeLanguage('../xml/videolose.xml', m_szLanguage);
	initChannel();
	enablecount();
...
<form id="outcfg_frm" name="outcfg_frm" method="post" action="/webs/loseCfgEx"  style="margin:0px; padding:0px;">
<div id="divMain">
	<div class="subtab">
		<ul>
			<li class="linow"><LABEL id="laHeadTitle">视频丢失报警设置</LABEL></li>
	...
	<table width="680" border="1" cellpadding="5" cellspacing="1" bgcolor="#999999" style="margin:0px;">
		<tr>
		  <td width="14%" height="21" align="right" bgcolor="#FFFFFF"><LABEL id="btnEnable">检测开关</LABEL></td>
		  <td colspan="4" bgcolor="#FFFFFF"><input name="ckdetect" type="checkbox" id="ckdetect" value="checkbox" onClick="checkClick('motion_frm','ckdetect')"/></td>
	    </tr>
		<tr>
