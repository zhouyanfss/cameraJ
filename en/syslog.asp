...
<div id="divMain">
	<div class="subtab" style="display:none;">
		<ul>
			<li class="linow"><LABEL id="laHeadTitle">日志查询</LABEL></li>
		  ...
		  <tr>
			...
			<td width="76" style="display:none;">
			  <select name="seltype" id="seltype">
				<option id="opType1" value="32" selected="selected">系统日志</option>
			  </select></td>
			<td width="86" align="right" id="Tdpageitem"><LABEL id="laPageItem">每页显示</LABEL></td>
			<td width="56"><select name="pagenumsel" id="pagenumsel" style="width:52px;">
...
<a hidefocus="true" class="btn69 act" href="javascript:;" onClick="funSearch(1000)"><LABEL id="btnSearchLog">查 询</LABEL></a>
			...
			<td><input name="searchFlag" type="hidden" id="searchFlag" value="1000"></td>
				...
				<li class="vrig" id="laMain2" style="width:704px; min-width:704px; height:320px; min-height:320px; padding:12px 0 0 12px;">
