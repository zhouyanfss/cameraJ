...
function funbtnSubmit(){
	...
	if(repsw == syspsw){	
		var strurl	= "/webs/btnHitEx?flag=21";
		window.parent.btnHit.location.href = strurl;
		setTimeout("window.top.location.href='./';",48000);
		//remarkDisplay("divAlertHTML", " ", 3E3, 1);
		playDiv();
	}else{
...
function init(){
	ChangeLanguage('../xml/sysreboot.xml', m_szLanguage);
	$("btnSave").addEvent("click", Checkfrm);
}
</script>
<body onLoad="parentinit(0,0,0);init();" onkeydown="KeyDownHandler();">
<form id="outcfg_frm" name="outcfg_frm" method="post" action="/webs/sysRebootCfgEx"  style="margin:0px; padding:0px;">
<div id="divMain">
	<div class="subtab" style="display:none;">
		<ul>
			<li class="linow"><LABEL id="laHeadTitle">重启设备</LABEL></li>
...
<LABEL id="laAlert"><span style="color:#FF0000">*</span> 单击此按钮将使设备重新启动。</LABEL>
				</li>
			</ul>
    ...
    <div class="foottab">
		<div class="set_btn">
			...
			<a hidefocus="true" href="javascript:;" id="btnSave"><LABEL id="btnSaveSumbit">重启设备</LABEL></a>
...
<div id="massage_box" style="display:none; ">
  <div class="massage"> 
    <div class="header" onmousedown=MDown(massage_box)> 
      	<div id="DivPRETitle"><LABEL id="laPasswordTitle">请输入你的登录密码</LABEL></div><span onClick="massage_box.style.visibility='hidden';" style="float:right; width:28px; height:100%; padding:0 0 3px 12px; display:inline; cursor:hand; font-size:14px; font-weight:600;"> × </span> 
	</div>
		<table width="99%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<td width="60%" valign="bottom" style=" padding:0 0 0 3px;"><input name="inputpsw" type="password" class="text" id="inputpsw" value="" style="width:86px;" maxlength="16" onFocus="this.select()" onMouseOver="this.focus()" /></td>
		  </tr>
		  <tr>
