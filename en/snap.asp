...
function init(){
	ChangeLanguage('../xml/snap.xml', m_szLanguage);
	initChannel();
	$("btnSave").addEvent("click", Checkfrm);
}
</script>
<body onLoad="parentinit(0,0,0);init();">
<form id="outcfg_frm" name="outcfg_frm" method="post" action="/webs/snapCfgEx"  style="margin:0px; padding:0px;">
<div id="divMain">
	<div class="subtab" style="display:none;">
		<ul>
			<li class="linow"><LABEL id="laHeadTitle">定时抓拍</LABEL></li>
	...
	<div class="maintab">
		...
		<tr>
		  <td height="23" align="right" ><LABEL id="laSnapInterval">抓拍时间间隔</LABEL></td>
		  <td height="23" align="left" ><div id="Divtime" style="float:left; padding-left:5px; padding-right:8px;"> <input name="capclear" type="text" class="textmin" style="width:52px;" id="capclear" maxlength="4">
                  </div><div id="Divtimeunit" style="float:left;"><LABEL id="laIntervalUnit">秒</LABEL></div></td>
		</tr>
		<tr>
		  <td width="136" height="19" align="right" id="Tdtime1"><LABEL id="laSnapTime1">布防时间段1</LABEL></td>
		  <td align="left"><input name="ckevery" type="checkbox" id="ckevery" value="checkbox" onClick="checkClick('record_frm','ckevery')" />
			<input name="begh1" type="text" class="textmin inputwidht" id="begh1" onKeyPress="event.returnValue=isDigit();" size="2" maxlength="2" />
		:
		<input name="begm1" type="text" class="textmin inputwidht" id="begm1" onKeyPress="event.returnValue=isDigit();" size="2" maxlength="2" />
		--
		...
		<tr>
		  <td height="25" align="right" id="Tdtime2"><LABEL id="laSnapTime2">布防时间段2</LABEL></td>
		...
		<tr>
		  <td height="23" align="right" ><LABEL id="laStorageMode">抓拍文件存储</LABEL></td>
		  <td height="23" align="left" >
							  <div id="strdivrecl" style="padding:0px; margin:0px; width:21px; float:left; display:none;"><input name="rec_local" type="checkbox" id="rec_local" value="checkbox" onClick="checkClick('record_frm','rec_local')"/></div><div id="Divpc" style="float:left; width:76px;display:none;"><LABEL id="laSnapPC">PC存储</LABEL></div>
				<div id="strdivrecd" style="padding:0px; margin:0px; width:21px; float:left;display:none;"><input name="rec_device" type="checkbox" id="rec_device" value="checkbox" onClick="checkClick('record_frm','rec_device')"/></div><div id="Divde" style="float:left; width:76px;display:none;"><LABEL id="laSnapDevice">设备存储</LABEL></div>
				<div id="strdivrece" style="padding:0px; margin:0px; width:21px; float:left; color:#999999; "><input name="rec_email" type="checkbox" id="rec_email" value="checkbox" onClick="checkClick('record_frm','rec_email')"/></div><div id="Divemail" style="float:left; width:76px; "><LABEL id="laSnapEmail">发送E-mail</LABEL></div>
				<div id="strdivrecf" style="padding:0px; margin:0px; width:21px; float:left;"><input name="rec_ftp" type="checkbox" id="rec_ftp" value="checkbox" onClick="checkClick('record_frm','rec_ftp')"/></div><div id="Divftp" style="float:left; width:76px;"><LABEL id="laSnapFtp">Ftp上传</LABEL></div>		  </td>
		</tr>
		</table>
				</li>
			</ul>
    ...
    <div class="foottab">
		...
		<span style="color:#FF0000; padding-right:5px;">*</span><LABEL id="laSnapAlert">默认只保存在设备端的存储设备里</LABEL></div>
		<div class="boxtap">
